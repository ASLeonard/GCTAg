...
int main(int argc, char *argv[]){
    ...
    vector<string> supported_flagsV2 = {"--test-covar",
        ...
        "--ld-matrix", "--r", "--ld-wind", "--r2", "--subtract-grm", "--merge-grms", "--save-pheno", "--save-bin", "--no-marker", "--joint-covar", "--sparse-cutoff", "--noblas", "--fastGWA-gram",
